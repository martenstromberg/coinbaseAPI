...
public class IAMDatabaseAuthenticationTester {
    ...
    private static final String RDS_INSTANCE_HOSTNAME = "my-first-instance.chr2fkeh9su8.eu-west-1.rds.amazonaws.com";
    ...
    private static final String DEFAULT_KEY_STORE_PASSWORD = "FgTbaukSwX8a4wPM";
